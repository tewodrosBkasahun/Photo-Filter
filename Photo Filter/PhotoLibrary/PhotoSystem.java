...
import Drivers.PhotoTools;

/**
 * Manages photo editing system.  A dialog box is displayed which allows the user
 * to load an image from the local machine or using an Internal URL.  Once the image
...
public class PhotoSystem {
	...
	static final int NUM_RADIO_BUTTONS = 11;
			...
			try {
				...
				while(true) {
					...
					if (radioButtons[0].isSelected()) {
						...
						photo = new Photograph(isb.getTextValue());
